...
## Getting Started
If you are new to robotics or new to the *package org.firstinspires.ftc.teamcode;
...
}* Tech Challenge, then you should consider reviewing the [FTC Blocks Tutorial](https://ftc-docs.firstinspires.org/programming_resources/blocks/Blocks-Tutorial.html) to get familiar with how to use the control system:
